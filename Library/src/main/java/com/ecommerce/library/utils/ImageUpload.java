...
public class ImageUpload {
    ...
    public boolean checkExist(MultipartFile multipartFile){
        ...
        try {
            File file = new File(UPLOAD_FOLDER +"C:\\Users\\Usario\\IdeaProjects\\Strawberry\\Ecommerce_St\\Admin\\src\\main\\resources\\static\\img\\Image-product" + multipartFile.getOriginalFilename());
            isExist = file.exists();
        }catch (Exception e){
            e.printStackTrace();
        }
